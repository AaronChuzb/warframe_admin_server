 ...
 * @LastEditTime: 2021-08-26 15:25:43
-->
<template>
  <div>
    <h1>部件列表</h1>
    <el-row :gutter="10">
      ...
      <el-col :span="4" :offset="12">
        <el-button style="width: 100%" type="primary" @click="$router.push('/part/edit')">新建部件</el-button>
      </el-col>
    </el-row>
    <el-table :data="categorys" style="margin-top: 1vw">
      <el-table-column align="center" prop="name" label="部件名称"></el-table-column>
      ...
      <el-table-column align="center" fixed="right" label="操作" width="180">
        <template slot-scope="scope">
          <el-button type="primary" size="small" @click="$router.push(`/part/edit/${scope.row._id}`)">编辑</el-button>
